...
type
  ...
  TfrmMidiDialog = class(TForm)
    ...
    Timer1: TTimer;
    procedure cbTestMidiInClick(Sender: TObject);
    procedure cbTestMidiOutClick(Sender: TObject);
...
procedure TfrmMidiDialog.cbTestMidiOutClick(Sender: TObject);
begin
...
procedure TfrmMidiDialog.cbTestMidiInClick(Sender: TObject);
begin
